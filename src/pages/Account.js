        ...
        !user.isAdmin && localStorage.getItem("token") != null
            ...
            <>
                <div className="account-cards d-flex flex-column flex-md-row justify-content-center align-items-center">
                    <Card className="mx-2 text-center" style={{ width: '18rem', minHeight: '300px' }} data-aos="flip-up">
                    ...
                    <Card className="mx-2 text-center" style={{ width: '18rem', minHeight: '300px' }} data-aos="flip-right">
                        <Card.Body className="d-flex flex-column justify-content-around align-items-center">
                    ...
                    <Card className="mx-2 text-center" style={{ width: '18rem', minHeight: '300px' }} data-aos="flip-down">
                        <Card.Body className="d-flex flex-column justify-content-around align-items-center">
